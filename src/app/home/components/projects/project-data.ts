...
export const projectData = [
  ...
  },
  {
    ...
    title: 'Visa Match',
    description:
      'Comprehensive immigration documentation for those looking to gain work experience abroad.\n\nThe site gathers and organizes official visa pathway information and condenses it into easy to understand guides.\n\nAn optional AI agent is available to provide guidance and answer questions about any visa program.',
    href: 'https://visamatch.co',
    imagePreview: VisaMatchPreviewImage,
  },
  {
    id: 3,
